...
namespace Mapbox.Platform
{
	...
	public class Response
	{
		...
		public static Response FromWebResponse(IAsyncRequest request, UnityWebRequest apiResponse, Exception apiEx)
		{
			...
			if ((apiResponse.result == UnityWebRequest.Result.ConnectionError || apiResponse.result == UnityWebRequest.Result.DataProcessingError || apiResponse.result == UnityWebRequest.Result.ProtocolError) && !string.IsNullOrEmpty(apiResponse.error))
			{
