...
namespace Mapbox.Unity.Telemetry
{
	...
	public class TelemetryEditor : ITelemetryLibrary
	{
		...
		IEnumerator PostWWW(string url, string bodyJsonString)
		{
			...
			if (!(postRequest.result == UnityWebRequest.Result.ConnectionError || postRequest.result == UnityWebRequest.Result.DataProcessingError || postRequest.result == UnityWebRequest.Result.ProtocolError))
			{
#else
